...
int main (int argc, char** argv) {
  ...
  shapes.clear();
  shapes.push_back(ImGuiShape("vLine##A_V_ImGuiShape", ImVec2(0, height/2.0), ImGuiCanvasShapeType::VLine, {0.0f, (float)height}, ImGuiCanvasClip::Out, true));
  shapes.push_back(ImGuiShape("vLine##B_V_ImGuiShape", ImVec2(width, height/2.0), ImGuiCanvasShapeType::VLine, {0.0f, (float)height}, ImGuiCanvasClip::In, true));
  shapes.push_back(ImGuiShape("hLine##A_H_ImGuiShape", ImVec2(width/2.0, 0.0), ImGuiCanvasShapeType::HLine, {0.0f, (float)width}, ImGuiCanvasClip::Out, true));
  shapes.push_back(ImGuiShape("hLine##B_H_ImGuiShape", ImVec2(width/2.0, height), ImGuiCanvasShapeType::HLine, {0.0f, (float)width}, ImGuiCanvasClip::In, true));
  // ==================================================================================================================
